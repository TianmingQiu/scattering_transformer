...
def data_loader(data_dir, batch_size_train=100, batch_size_test=1000, workers=2, pin_memory=True):
...
train_loader,test_loader = data_loader(DOWNLOAD_PATH, batch_size_train=BATCH_SIZE_TRAIN, batch_size_test=BATCH_SIZE_TEST, workers=2, pin_memory=True)
