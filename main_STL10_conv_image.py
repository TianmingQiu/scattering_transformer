...
from models.vit_pytorch import ViT, ViT_scatter, ViT_with_conv
...
model = ViT_with_conv(image_size=96, patch_size=8, num_classes=10, channels=3,
...
save_path = SAVE_FOLDER + '/stl_vit_s_image.pth'
