...
save_path = SAVE_FOLDER + '/t_imagenet_base_' + str(PATCH_SIZE)+ '-' + str(DEPTH) + '.pth'
image_path = RESULT_FOLDER + '/t_imagenet_base_' + str(PATCH_SIZE)+ '-' + str(DEPTH) + '.png'

torch.save((model.state_dict(),accuracy_history,test_loss_history), save_path)
print('Model saved to', save_path)

# save(model, accuracy_history, test_loss_history, save_path)
