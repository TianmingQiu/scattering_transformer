...
model = PSViT(img_size=IMAGE_SIZE, embed_dim=EMBED_DIM, num_point_w=IMAGE_SIZE/PATCH_SIZE, num_point_h=IMAGE_SIZE/PATCH_SIZE, num_classes=NUM_CLASS, num_iters=NUM_ITER, depth=DEPTH,
              num_heads=HEAD, mlp_ratio=MLP_RATIO, offset_gamma=1., offset_bias=True, with_cls_token=True)
