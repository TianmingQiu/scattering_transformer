...
from models.vit_pytorch import ViT, ViT_scatter, ViT_with_conv_head
...
model = ViT_with_conv_head(image_size=96, patch_size=8, num_classes=102, channels=3,
...
save_path = SAVE_FOLDER + '/flowers_vit.pth'
